...
export default function Page() {
  return (
    <>
      <Preloader />
      <div className="relative min-h-screen w-full overflow-hidden bg-black opacity-0 animate-fade-in" style={{ animationDelay: '3.5s' }}>
        ...
        <div className="relative z-10 w-full h-full flex flex-col">
          <div className="p-12 pr-24 sm:pr-12">
            <h1 className="text-2xl font-extralight tracking-tight text-white opacity-0 animate-fade-in" style={{ animationDelay: '3.8s' }}>
          ...
          <div className="flex-1 flex flex-col justify-center px-12 pr-24 sm:pr-12 space-y-12 mt-0 md:mt-32">
            <div className="space-y-4 max-w-4xl md:ml-[200px]">
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-extralight tracking-wide leading-tight bg-gradient-to-r from-white via-white/90 to-white/80 bg-clip-text text-transparent opacity-0 animate-fade-in" style={{ animationDelay: '4.0s' }}>
                Elevate your <span className="text-green-400">wealth</span>, amplify your future
              </h2>
              <p className="text-2xl md:text-3xl lg:text-4xl font-extralight text-white/80 tracking-wider opacity-0 animate-fade-in" style={{ animationDelay: '4.2s' }}>
                Where AI meets <span className="text-green-400">financial excellence</span>
              </p>
              <div className="pt-4 opacity-0 animate-fade-in" style={{ animationDelay: '4.4s' }}>
                <Button 
                  variant="ghost" 
                  size="lg"
        ...
        <div className="fixed bottom-12 left-12 pr-24 sm:pr-12 z-20">
          <p className="text-2xl text-white/80 font-extralight tracking-wide opacity-0 animate-fade-in" style={{ animationDelay: '4.6s' }}>
